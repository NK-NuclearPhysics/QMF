...
C     
C
      OPEN(UNIT=10,FILE='output350 2.rmf',STATUS='UNKNOWN')
      OPEN(UNIT=11,FILE='output350 2.dat',STATUS='UNKNOWN')
      OPEN(UNIT=41,FILE='test350 2.rmf',STATUS='UNKNOWN')
      OPEN(UNIT=42,FILE='test2 350 2.rmf',STATUS='UNKNOWN')
C
...
C     ADD LAMDA
      ...
      OPEN(UNIT=04,FILE='qmf dirac350.DAT',STATUS='OLD')
      OPEN(UNIT=03,FILE='DIRAC350 2.CHK',STATUS='UNKNOWN')
C
      READ(04,*) NNY
      DO 100 I=1,NNY
...
C
      IF(IWRIT.GE.2) THEN
       OPEN(UNIT=50,FILE='densit350 2.rmf',STATUS='UNKNOWN')
       WRITE(50,'(A,/,2(A,I3),/,A)')
     *    '++++++++++++++++++++++++++++++++++++++++++++++++++++++',
...
C
      IF(IWRIT.GE.3) THEN
       OPEN(UNIT=51,FILE='wfnmes350 2.rmf',STATUS='UNKNOWN')
       WRITE(51,'(A,/,2(A,I3),/,A)')
     *    '++++++++++++++++++++++++++++++++++++++++++++++++++++++',
     *       'NPROT=',NPROT,'   NNEUT=',NNEUT,
     *    '++++++++++++++++++++++++++++++++++++++++++++++++++++++'
...
C
  ...
  400  CONTINUE
C
       OPEN(UNIT=52,FILE='wfnbar350 2.rmf',STATUS='UNKNOWN')
...
c      vmestc=-vmescp
      vmestc=0.d0
      VMESCPL=VMESCP*0.7726D0*RGW(ITURN)
